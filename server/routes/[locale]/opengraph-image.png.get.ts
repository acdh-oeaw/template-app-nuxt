...
export default defineLazyEventHandler(async () => {
	...
	for (const locale of locales) {
		...
		const description = t("DefaultLayout.meta.description");
							...
							props: {
								...
								children: [
									...
									},
									{
										type: "path",
										props: {
											d: "M354.406 344.453v9.711a24.952 24.952 0 0 0-1.698-2.115c-4.101-4.514-9.164-7.001-15.177-7.472a26.793 26.793 0 0 0-2.14-.091c-.728 0-1.44.035-2.142.091-6.042.472-11.115 2.974-15.219 7.511-4.147 4.585-6.225 9.993-6.242 16.225l-.001.068.001.064c.017 6.288 2.216 11.786 6.6 16.495 4.398 4.724 10.062 7.086 17.003 7.086 6.91 0 12.564-2.362 16.964-7.086a26.564 26.564 0 0 0 2.049-2.524v24.037a24.16 24.16 0 0 0-1.697-2.108c-4.578-5.045-10.35-7.564-17.315-7.564-6.995 0-12.779 2.535-17.361 7.602-4.147 4.583-6.225 9.99-6.242 16.225l-.001.068.001.062c.017 6.286 2.216 11.79 6.6 16.496 4.397 4.722 10.062 7.085 17.003 7.085 6.91 0 12.562-2.363 16.966-7.085a26.984 26.984 0 0 0 2.047-2.527v9.747h5.027v-99.999h-5.026zm-18.855 42.967c-10.515 0-19.037-8.522-19.037-19.037 0-10.514 8.522-19.034 19.037-19.034 9.676 0 17.644 7.223 18.854 16.569v4.933c-1.21 9.346-9.178 16.569-18.854 16.569zm.003 52.289c-10.517 0-19.039-8.521-19.039-19.036 0-10.516 8.522-19.034 19.039-19.034 9.676 0 17.641 7.22 18.852 16.569v4.933c-1.211 9.346-9.176 16.568-18.852 16.568z",
										},
									},
								],
							},
		...
		images.set(locale, png);
	}

	const localeSchema = v.picklist(locales);

	return defineEventHandler((event) => {
		const locale = v.parse(localeSchema, getRouterParam(event, "locale"));

		setHeader(event, "content-type", "image/png");
		setHeader(event, "cache-control", "public, max-age=31536000, immutable");

		return images.get(locale)!;
	});
});
